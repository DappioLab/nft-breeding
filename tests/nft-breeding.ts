...
describe("NFT Breeding", () => {
  ...
  const parentAUri = "https://arweave.net/UNvkUJj3uNU9rRxGrp5om2JyC0QDW-DCZkXB4Q427gs";
  ...
  const parentBUri = "https://arweave.net/V0_nkGdRNEdggue1B-w9jdtqVvs1uVLkPPZjjYs6n3s";
  const parentBUriPath = "./uri/parentBUri.json"
  let parentBAttributes: string[] = [];

  const childMint = Keypair.generate();
  const childUri = "https://arweave.net/Uugbviekk9LERxdcG-WSfiOja4hKe1wgJekPNLoL9Hk";
